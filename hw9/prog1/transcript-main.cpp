...
*@Author        : Dr Zack Butler : zjb@cs.rit.edu
...
int main() {
  ...
  //Demo : overloading operator << for class course
  cout<<"Demo of Course << operator"<<endl;
  cout<<c1<<endl<<endl;
  //Demo : overloading operator << for class Transcript
  cout<<"Demo of Transcript << operator"<<endl;
  cout<<t1;
